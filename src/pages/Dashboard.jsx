...
export default function Dashboard() {
  const { user, setUser, data } = useContext(CartContext)
          ...
          <div className="flex items-center gap-4">
            <div className="relative bg-gray-200 px-3 py-2 cursor-pointer rounded-md flex items-center justify-center w-10 h-10">
              <Link to='messages'>
                ...
                <div className="absolute -top-1 -right-1 bg-white text-blue-500 text-xs rounded-full h-5 w-5 flex items-center justify-center">
                  1
                </div>
              </Link>
            </div>
